	...
	<div class="shopping-cart">
		<div class="px-4 px-lg-0">
			<div class="pb-5 pt-3">
				<div class="container">
					<div class="row">
						<div class="col-lg-12 p-5 bg-danger rounded shadow-sm mb-5">
							<!-- Shopping cart table -->
									...
									<tbody>
										...
										<c:forEach items="${o.items}" var="i">
											<tr>
												<th scope="row">
													<div class="p-2">
														<img src="${i.product.imagine}" alt="" width="70"
															class="img-fluid rounded shadow-sm">
														<div class="ml-3 d-inline-block align-middle">
															<h5 class="mb-0">
																<a href="#" class="text-dark d-inline-block">${i.product.title}</a>
															</h5>
												...
												<td class="align-middle"><a
													href="process?num=-1&id=${i.product.id}"><button
															class="btnSub">-</button></a> <strong>${i.quantity}</strong>
													<a href="process?num=1&id=${i.product.id}"><button
															class="btnAdd">+</button></a></td>
														<td class="align-middle"><strong><fmt:formatNumber pattern="##.#" value="${i.quantity*i.price }"/></strong></td>	
												<td class="align-middle"><a
													href="deletecart?id=${i.product.id}" class="text-dark">
														<button type="button"
							...
							<div class="p-4">
								<ul class="list-unstyled mb-4">
									...
									<li class="d-flex justify-content-between py-3 border-bottom"><strong
										class="text-muted">Tổng tiền hàng</strong><strong>VNĐ  ${o.getTotalMoney()}</strong></li>
									<li class="d-flex justify-content-between py-3 border-bottom"><strong
									...
									<li class="d-flex justify-content-between py-3 border-bottom"><strong
										...
										<h5 class="font-weight-bold"> VNĐ ${o.getTotalMoney()}</h5></li>
								</ul>
								<a href="order"
									class="btn btn-danger rounded-pill py-2 btn-block">Mua hàng</a>
							</div>
						</div>
					</div>
